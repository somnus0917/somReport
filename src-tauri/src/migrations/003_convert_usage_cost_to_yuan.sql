...
INSERT INTO api_usage_new (id, occurred_at, provider, model, input_tokens, output_tokens, estimated_cost_yuan, job_id)
    SELECT id, occurred_at, provider, model, input_tokens, output_tokens, estimated_cost_cents / 100.0, job_id FROM api_usage;
